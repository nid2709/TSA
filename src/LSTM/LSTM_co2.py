...
from src.LSTM.LSTM_dataset import prepare_lstm_data
from src.LSTM.LSTM_plots import (
    plot_attention_weights,
    plot_forecast_comparison,
    plot_loss_curves,
    plot_scattering_wavelet_features,
)
from src.LSTM.LSTM_data_processing import save_future_target_reference

# Re-export commonly used helpers for older imports.
from src.LSTM.LSTM_dataset import create_loader, create_sequences
from src.LSTM.LSTM_plots import (
...
def run_lstm_model(
    ...
    print("\n========== LSTM RUNTIME ==========")
    print("LSTM runtime seconds:", run_elapsed_time)
    print("LSTM runtime:", format_elapsed_time(run_elapsed_time))

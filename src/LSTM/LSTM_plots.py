...
from src.LSTM.LSTM_scattering import get_scattering_feature_names
...
def plot_scattering_wavelet_features(
    ...
    axes[1].set_title(
        f"Static Scattering Features Used by LSTM "
...
def plot_attention_weights(model, test_loader, results_dir):
    ...
    ax.set_title("LSTM Temporal Attention Heatmap")
    fig.tight_layout()

...
def graph_for_actual_vs_predection(test_actuals_original, test_predictions_original):
    ...
    plt.plot(test_actuals_original[:100], label="Actual Temperature")
    plt.plot(test_predictions_original[:100], label="Predicted Temperature")
...
def graph_for_scatter_actual_vs_prediction(test_actuals_original, test_predictions_original):
    ...
    ax[0].set_title("Actual Temperature Scatter")
    ax[0].grid(True)
    ...
    ax[1].set_title("Predicted Temperature Scatter")
    ax[1].grid(True)
...
def model_pipeline_Temp(feature_df):
